...
::move vpks
cd "%dev_folder%" 
IF EXIST "%vpk_name%_dir.vpk" move "%vpk_name%_dir.vpk" "%custom_folder%\%vpk_name%_dir.vpk" >nul
IF EXIST "%vpk_name%_000.vpk" move "%vpk_name%_000.vpk" "%custom_folder%\%vpk_name%_000.vpk" >nul
IF EXIST "%vpk_name%_001.vpk" move "%vpk_name%_001.vpk" "%custom_folder%\%vpk_name%_001.vpk" >nul
IF EXIST "%vpk_name%_001.vpk" move "%vpk_name%_002.vpk" "%custom_folder%\%vpk_name%_002.vpk" >nul
IF EXIST "%vpk_name%_003.vpk" move "%vpk_name%_003.vpk" "%custom_folder%\%vpk_name%_003.vpk" >nul
IF EXIST "%vpk_name%_004.vpk" move "%vpk_name%_004.vpk" "%custom_folder%\%vpk_name%_004.vpk" >nul
