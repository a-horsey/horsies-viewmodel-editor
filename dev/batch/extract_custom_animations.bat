...
@echo OFF
cd "%vm_customizer_folder%\your custom animations"
IF NOT EXIST "*.vpk" goto :EOF

title Checking for custom animations...
echo Checking for custom animations...
...
cd "%dev_folder%"
HLExtract.exe -s -p "%vm_customizer_folder%\your custom animations\%custom_animation%" -d "%dev_folder%\decompiled_custom_animations_temp" -e "models\weapons\c_models\c_scout_animations.mdl" >nul
HLExtract.exe -s -p "%vm_customizer_folder%\your custom animations\%custom_animation%" -d "%dev_folder%\decompiled_custom_animations_temp" -e "models\weapons\c_models\c_soldier_animations.mdl" >nul
HLExtract.exe -s -p "%vm_customizer_folder%\your custom animations\%custom_animation%" -d "%dev_folder%\decompiled_custom_animations_temp" -e "models\weapons\c_models\c_pyro_animations.mdl" >nul
HLExtract.exe -s -p "%vm_customizer_folder%\your custom animations\%custom_animation%" -d "%dev_folder%\decompiled_custom_animations_temp" -e "models\weapons\c_models\c_demo_animations.mdl" >nul
HLExtract.exe -s -p "%vm_customizer_folder%\your custom animations\%custom_animation%" -d "%dev_folder%\decompiled_custom_animations_temp" -e "models\weapons\c_models\c_heavy_animations.mdl" >nul
HLExtract.exe -s -p "%vm_customizer_folder%\your custom animations\%custom_animation%" -d "%dev_folder%\decompiled_custom_animations_temp" -e "models\weapons\c_models\c_engineer_animations.mdl" >nul
HLExtract.exe -s -p "%vm_customizer_folder%\your custom animations\%custom_animation%" -d "%dev_folder%\decompiled_custom_animations_temp" -e "models\weapons\c_models\c_medic_animations.mdl" >nul
HLExtract.exe -s -p "%vm_customizer_folder%\your custom animations\%custom_animation%" -d "%dev_folder%\decompiled_custom_animations_temp" -e "models\weapons\c_models\c_sniper_animations.mdl" >nul
HLExtract.exe -s -p "%vm_customizer_folder%\your custom animations\%custom_animation%" -d "%dev_folder%\decompiled_custom_animations_temp" -e "models\weapons\c_models\c_spy_animations.mdl" >nul

::mark as incompatible if animation models exist
...
IF EXIST "%dev_folder%\decompiled_custom_animations_temp\c_scout_animations.mdl" (
	CrowbarCommandLineDecomp.exe -p "%dev_folder%\decompiled_custom_animations_temp\c_scout_animations.mdl" -o "%dev_folder%\decompiled_custom_animations_temp" >nul )
IF EXIST "%dev_folder%\decompiled_custom_animations_temp\c_soldier_animations.mdl" (	
	CrowbarCommandLineDecomp.exe -p "%dev_folder%\decompiled_custom_animations_temp\c_soldier_animations.mdl" -o "%dev_folder%\decompiled_custom_animations_temp" >nul )
IF EXIST "%dev_folder%\decompiled_custom_animations_temp\c_pyro_animations.mdl" (	
	CrowbarCommandLineDecomp.exe -p "%dev_folder%\decompiled_custom_animations_temp\c_pyro_animations.mdl" -o "%dev_folder%\decompiled_custom_animations_temp" >nul )
IF EXIST "%dev_folder%\decompiled_custom_animations_temp\c_demo_animations.mdl" (	
	CrowbarCommandLineDecomp.exe -p "%dev_folder%\decompiled_custom_animations_temp\c_demo_animations.mdl" -o "%dev_folder%\decompiled_custom_animations_temp" >nul )
IF EXIST "%dev_folder%\decompiled_custom_animations_temp\c_heavy_animations.mdl" (	
	CrowbarCommandLineDecomp.exe -p "%dev_folder%\decompiled_custom_animations_temp\c_heavy_animations.mdl" -o "%dev_folder%\decompiled_custom_animations_temp" >nul )
IF EXIST "%dev_folder%\decompiled_custom_animations_temp\c_engineer_animations.mdl" (	
	CrowbarCommandLineDecomp.exe -p "%dev_folder%\decompiled_custom_animations_temp\c_engineer_animations.mdl" -o "%dev_folder%\decompiled_custom_animations_temp" >nul )
IF EXIST "%dev_folder%\decompiled_custom_animations_temp\c_medic_animations.mdl" (	
	CrowbarCommandLineDecomp.exe -p "%dev_folder%\decompiled_custom_animations_temp\c_medic_animations.mdl" -o "%dev_folder%\decompiled_custom_animations_temp" >nul )
IF EXIST "%dev_folder%\decompiled_custom_animations_temp\c_sniper_animations.mdl" (	
	CrowbarCommandLineDecomp.exe -p "%dev_folder%\decompiled_custom_animations_temp\c_sniper_animations.mdl" -o "%dev_folder%\decompiled_custom_animations_temp" >nul )
IF EXIST "%dev_folder%\decompiled_custom_animations_temp\c_spy_animations.mdl" (	
	CrowbarCommandLineDecomp.exe -p "%dev_folder%\decompiled_custom_animations_temp\c_spy_animations.mdl" -o "%dev_folder%\decompiled_custom_animations_temp" >nul )
