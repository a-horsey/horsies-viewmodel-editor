...
IF NOT %Keep_backstab_visible(y/n)%==y echo $append %backstab_attack_sequence% %hide_origin_value% fadein 0.0 fadeout 0.0 >> %qc_file%
...
IF NOT %Keep_backstab_visible(y/n)%==y echo $append %backstab_stun_sequence% %hide_origin_value% fadein 0.0 fadeout 0.0 >> %qc_file%
...
IF NOT %Keep_backstab_detection_visible(y/n)%==y echo $append %backstab_detect_sequence_up% %hide_origin_value% fadein 0.0 fadeout 0.0 >> %qc_file%
...
IF %•Instant_backstab_detection(y/n)%==y IF %Keep_backstab_detection_visible(y/n)%==y (
	echo $append %backstab_detect_sequence_down% %hide_origin_value% fadein 0.0 fadeout 0.0 >> %qc_file%
	goto :hide_backstab_detection_3 )
IF NOT %Keep_backstab_detection_visible(y/n)%==y echo $append %backstab_detect_sequence_down% %hide_origin_value% fadein 0.0 fadeout 0.0 >> %qc_file%
...
IF NOT %Keep_backstab_detection_visible(y/n)%==y echo $append %backstab_detect_sequence_idle% %hide_origin_value% fadein 0.0 fadeout 0.0 >> %qc_file%
